...
export default function Page() {
  ...
  // Example: add a new item when submit button is clicked
  const handleAdd = () => {
    ...
    const newItem: MenuItem = {
      ...
      icon: <ContainerOutlined />,
      label: "https://www.mangozero.com/wp-content/uploads/2023/11/IMG_7598-600x600.jpg", // you can also bind this from another input if needed
      color: "#000",
                        ...
                        <Col span={14}>
                          ...
                          <div className="text-dot">
                            <small className="text-small">
                              ...
                              adipisicing elit. Rem obcaecati eum, in totam
                              natus exercitationem ducimus dolorem. Distinctio
                              tempore non laudantium animi? Non saepe laboriosam
                              architecto exercitationem placeat consectetur
                              iste.
                            </small>
                          </div>
                        </Col>
            ...
            <Card variant="borderless" className="card-messenger">
              ...
              <Row>
                ...
                <Col span={2}>
                  ...
                  /> */}
                  <LinkOutlined onClick={handleAdd} className="icon-message" />
                  <SendOutlined onClick={handleAdd} className="icon-message" />
                </Col>
              </Row>
            </Card>
          </Col>
